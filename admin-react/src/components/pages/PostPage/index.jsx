...
const PostPage = () => {
  ...
  const getBlogData = async () => {
    const res = await getRequest(
      `/get-blog?search=${search}&pageNumber=${currentPage}&pageSize=${pageSize}`
    );
                        ...
                        {getBlog.map((value, index) => {
                          ...
                          return (
                            <tr>
                              ...
                              <td>
                                <img className="img-fluid" src={`${ServerUrl}/Blogs/${value.blogImage}`} style={{width:"2rem"}}/>
                              </td>
                              <td>{value.title}</td>
                              ...
                              <td>
                                <button
                                  onClick={()=>history(`/post/edit/${value._id}`)}
